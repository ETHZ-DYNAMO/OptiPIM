module attributes {torch.debug_module_name = "ModelingMatmul"} {
  ...
  func.func @forward(%arg0: tensor<256x4096xf32>) -> tensor<256x4096xf32> {
    ...
    %4 = linalg.matmul {global_layer_idx = 0 : i32, layer_group = 0 : i32, num_banks = 16 : i32, type_layer_idx = 0 : i32} ins(%arg0, %1 : tensor<256x4096xf32>, tensor<4096x4096xf32>) outs(%3 : tensor<256x4096xf32>) -> tensor<256x4096xf32>
