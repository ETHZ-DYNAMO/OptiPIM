module attributes {torch.debug_module_name = "ModelingMatmul"} {
  ...
  func.func @forward(%arg0: tensor<32x128x128xf32>) -> tensor<32x128x128xf32> {
    ...
    %3 = linalg.batch_matmul {global_layer_idx = 0 : i32, layer_group = 0 : i32, num_banks = 16 : i32, type_layer_idx = 0 : i32} ins(%arg0, %1 : tensor<32x128x128xf32>, tensor<32x128x128xf32>) outs(%2 : tensor<32x128x128xf32>) -> tensor<32x128x128xf32>
