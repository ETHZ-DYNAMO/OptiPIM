...
module attributes {torch.debug_module_name = "Conv2d"} {
  ...
  func.func @forward(%arg0: tensor<1x512x28x28xf32>) -> tensor<1x512x28x28xf32> {
    ...
    %2 = linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, global_layer_idx = 0 : i32, layer_group = 0 : i32, num_banks = 16 : i32, strides = dense<1> : vector<2xi64>, type_layer_idx = 0 : i32} ins(%padded, %cst : tensor<1x512x30x30xf32>, tensor<512x512x3x3xf32>) outs(%1 : tensor<1x512x28x28xf32>) -> tensor<1x512x28x28xf32>
