module attributes {torch.debug_module_name = "Conv2d"} {
  ...
  func.func @forward(%arg0: tensor<1x512x28x28xf32>) -> tensor<1x256x28x28xf32> {
    ...
    %2 = linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%arg0, %cst : tensor<1x512x28x28xf32>, tensor<256x512x1x1xf32>) outs(%1 : tensor<1x256x28x28xf32>) -> tensor<1x256x28x28xf32>
