...
module attributes {torch.debug_module_name = "Conv2d"} {
  ...
  func.func @forward(%arg0: tensor<1x3x224x224xf32>) -> tensor<1x64x112x112xf32> {
    ...
    %2 = linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, global_layer_idx = 0 : i32, layer_group = 0 : i32, num_banks = 16 : i32, strides = dense<2> : vector<2xi64>, type_layer_idx = 0 : i32} ins(%padded, %cst : tensor<1x3x230x230xf32>, tensor<64x3x7x7xf32>) outs(%1 : tensor<1x64x112x112xf32>) -> tensor<1x64x112x112xf32>
