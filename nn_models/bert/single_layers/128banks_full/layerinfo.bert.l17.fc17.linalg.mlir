...
module {
  func.func @batch_matmul_1x128x3072x768(%arg0: tensor<1x128x3072xf32>, %arg1: tensor<1x3072x768xf32>) -> tensor<1x128x768xf32> {
    ...
    %3 = linalg.batch_matmul {global_layer_idx = 0 : i32, layer_group = 0 : i32, num_banks = 128 : i32, type_layer_idx = 0 : i32} ins(%arg0, %1 : tensor<1x128x3072xf32>, tensor<1x3072x768xf32>) outs(%2 : tensor<1x128x768xf32>) -> tensor<1x128x768xf32>
